...
class TestPhase4GoalArbiter:
    ...
    async def test_arbiter_initialization_with_weights(self, test_config, test_db):
    ...
    async def test_score_single_goal(self, test_config, test_db, test_user):
    ...
    async def test_high_priority_goal_scores_higher(self, test_config, test_db, test_user):
    ...
    async def test_user_explicit_goals_score_higher_than_curiosity(self, test_config, test_db, test_user):
    ...
    async def test_rank_multiple_goals(self, test_config, test_db, test_user):
    ...
    async def test_score_breakdown_contains_all_dimensions(self, test_config, test_db, test_user):
    ...
    async def test_priority_band_assignment(self, test_config, test_db, test_user):
    ...
    async def test_freshness_score_decays_over_time(self, test_config, test_db, test_user):
    ...
    async def test_get_intention_set_returns_intention_set(self, test_config, test_db, test_user):
