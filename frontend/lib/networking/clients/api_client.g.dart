...
class _AicoApiClient implements AicoApiClient {
  ...
  Future<AdminHealthResponse> getAdminHealth() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<AdminHealthResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/health',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late AdminHealthResponse _value;
    try {
      _value = AdminHealthResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<GatewayStatusResponse> getGatewayStatus() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<GatewayStatusResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late GatewayStatusResponse _value;
    try {
      _value = GatewayStatusResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<LogsListResponse> getLogs({
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<LogsListResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/admin/logs',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late LogsListResponse _value;
    try {
      _value = LogsListResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
  ...
  Future<DetailedHealthResponse> getDetailedHealth() async {
    ...
    final _headers = <String, dynamic>{};
    const Map<String, dynamic>? _data = null;
    final _options = _setStreamType<DetailedHealthResponse>(
      Options(method: 'GET', headers: _headers, extra: _extra)
          .compose(
            _dio.options,
            '/health/detailed',
    ...
    final _result = await _dio.fetch<Map<String, dynamic>>(_options);
    late DetailedHealthResponse _value;
    try {
      _value = DetailedHealthResponse.fromJson(_result.data!);
    } on Object catch (e, s) {
      errorLogger?.logError(e, s, _options);
      rethrow;
    }
