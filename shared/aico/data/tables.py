...
user_feedback_requests = Table(
    ...
    Column('rating', Float),
    Column('responded_at', TIMESTAMP(timezone=True)),
    Column('created_at', TIMESTAMP(timezone=True), nullable=False),
...
agency_plan_executions = Table(
    ...
    Column('started_at', TIMESTAMP(timezone=True)),
    Column('completed_at', TIMESTAMP(timezone=True)),
    Column('paused_at', TIMESTAMP(timezone=True)),
...
system_event_metrics = Table(
    ...
    Column('bucket_start', TIMESTAMP(timezone=True), nullable=False),
...
arbiter_bandit_arms = Table(
    ...
    Column('last_pulled', TIMESTAMP(timezone=True)),
    Column('active', Boolean, default=True),
    Column('created_at', TIMESTAMP(timezone=True), nullable=False),
    Column('updated_at', TIMESTAMP(timezone=True), nullable=False),
...
ethics_decisions_cache = Table(
    ...
    Column('cached_at', TIMESTAMP(timezone=True), nullable=False),
    Column('expires_at', TIMESTAMP(timezone=True)),
