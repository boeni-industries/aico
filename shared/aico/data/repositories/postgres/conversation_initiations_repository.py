"""
ConversationInitiationsRepository - PostgreSQL implementation
...
class PostgresConversationInitiationsRepository(Repository[ConversationInitiation]):
    """PostgreSQL implementation of conversation initiations repository."""
    ...
    async def get_by_id(self, entity_id: str) -> Optional[ConversationInitiation]:
        ...
        stmt = select(conversation_initiations).where(conversation_initiations.c.initiation_id == entity_id)
    ...
    async def delete(self, entity_id: str) -> bool:
        ...
        stmt = delete(conversation_initiations).where(conversation_initiations.c.initiation_id == entity_id)
        result = await self.session.execute(stmt)
    ...
    async def get_pending_initiations(self, user_id: str) -> List[ConversationInitiation]:
        """Get pending conversation initiations for a user."""
        ...
        ).order_by(conversation_initiations.c.initiated_at.asc())
