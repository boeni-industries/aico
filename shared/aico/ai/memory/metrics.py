...
results_count = meter.create_histogram(
...
def track_query(
    ...
    **extra_attributes
    ...
    try:
        ...
        results_count.record(tracker_state["results_count"], attributes)
...
def record_query(
    ...
    **extra_attributes
    ...
    query_duration.record(duration_seconds, attributes)
    query_counter.add(1, attributes)
    results_count.record(results_count_value, attributes)
