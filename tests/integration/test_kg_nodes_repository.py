...
class TestKGNodesRepository:
    ...
    async def test_create_node(self, uow, test_user):
        node = KGNode(
            ...
            label="PERSON",
            properties={"name": "Bob", "test_id": str(uuid.uuid4())},
            confidence=0.9,
    ...
    async def test_get_node_by_id(self, uow, test_user):
        node = KGNode(
            ...
            user_id=test_user.uuid,
            label="LOCATION",
            properties={"name": "Charlie", "test_id": str(uuid.uuid4())},
            confidence=0.95,
    ...
    async def test_update_node(self, uow, test_user):
        node = KGNode(
            ...
            user_id=test_user.uuid,
            label="PERSON",
            properties={"name": "Alice", "test_id": str(uuid.uuid4())},
            confidence=0.8,
    ...
    async def test_count_nodes(self, uow, test_user):
        for i in range(3):
            node = KGNode(
                ...
                user_id=test_user.uuid,
                label="LOCATION",
                properties={"name": f"City{i}", "test_id": str(uuid.uuid4())},
                confidence=0.9,
    ...
    async def test_get_user_nodes(self, uow, test_user):
        for i in range(3):
            node = KGNode(
                ...
                user_id=test_user.uuid,
                label="PERSON",
                properties={"name": f"Entity{i}", "test_id": str(uuid.uuid4())},
                confidence=0.9,
